...
async function guardarCredenciales() {
    ...
    if (cambioEmail) {
        ...
        try {
            const res  = await (window.apiFetch || fetch)('../../../api/users/check-email.php', {
                method:  'POST',
                headers: { 'Content-Type': 'application/json' },
            ...
            const res2  = await (window.apiFetch || fetch)('../../../api/users/update-credentials.php', {
                method:  'POST',
                headers: { 'Content-Type': 'application/json' },
                body:    JSON.stringify({ email }),
            });
    ...
    if (cambioTel) {
        ...
        try {
            const res  = await (window.apiFetch || fetch)('../../../api/verification/send-code.php', {
                method:  'POST',
                headers: { 'Content-Type': 'application/json' },
...
async function verificarCodigoWa() {
    ...
    try {
        const res  = await (window.apiFetch || fetch)('../../../api/users/update-credentials.php', {
            method:  'POST',
            headers: { 'Content-Type': 'application/json' },
            body:    JSON.stringify({
...
async function cambiarPassword() {
    ...
    try {
        ...
        const res  = await (window.apiFetch || fetch)('../../../api/users/change-password.php', {
            method:  'POST',
            headers: { 'Content-Type': 'application/json' },
...
async function confirmarEliminar() {
    ...
    try {
        const res  = await (window.apiFetch || fetch)('../../../api/users/delete-account.php', {
            method:  'POST',
            headers: { 'Content-Type': 'application/json' },
        });
        const data = await res.json();
